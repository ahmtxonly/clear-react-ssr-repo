...
module.exports = {
  ...
  moduleNameMapper: {
    ...
    '\\.svg': '<rootDir>/tools/__mocks__/svgrMock.js',
    '^Images(.*)$': '<rootDir>/src/images/$1',
    '^Components(.*)$': '<rootDir>/src/components/$1',
    '^Middlewares(.*)$': '<rootDir>/src/store/middlewares/$1',
    '^ApplicationContext$': '<rootDir>/src/components/ApplicationContext.js',
    '^History$': '<rootDir>/src/history.js',
  ...
  resetMocks: true, // we don't need to worry about cleanup on every test case
  ...
  transform: {
    ...
    '^(?!.*\\.(json|css)$)': '<rootDir>/tools/lib/fileTransformer.js',
  },
