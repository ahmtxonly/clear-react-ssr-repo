...
const reStyle = /\.(css|scss|sss|less)$/;
...
const config = {
  ...
  resolve: {
    alias: {
      Actions: resolvePath(SRC_DIR, 'actions/'),
      ApplicationContext: resolvePath(
        SRC_DIR,
        'components/ApplicationContext.js'
      ),
      Constants: resolvePath(SRC_DIR, 'constants/'),
      Components: resolvePath(SRC_DIR, 'components/'),
      History: resolvePath(SRC_DIR, 'history.js'),
      Images: resolvePath(SRC_DIR, 'images/'),
      Middlewares: resolvePath(SRC_DIR, 'store/middlewares/'),
      Utils: resolvePath(SRC_DIR, 'utils/'),
    },
    // Allow absolute paths in imports, e.g. import Button from 'components/Button'
    // Keep in sync with and .eslintrc
